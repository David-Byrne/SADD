...
[1] - [Machine Learning A Probabilistic Perspective](https://www.cs.ubc.ca/~murphyk/MLbook/pml-intro-22may12.pdf) by Kevin P. Murphy.
(Although this text uses some different terminology to this report, the concepts it is describing are the same.)

[2] - [Machine Learning](http://www.cs.ubbcluj.ro/~gabis/ml/ml-books/McGrawHill%20-%20Machine%20Learning%20-Tom%20Mitchell.pdf) by Tom M. Mitchell
